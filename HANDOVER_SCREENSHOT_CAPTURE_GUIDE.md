...
```text
คุณคือ UI QA Automation Agent โปรดเปิด Web Application Kampan ที่ Base URL: http://localhost:5000 (หรือ Staging URL ที่กำหนด) ทำการล็อกอิน และนำทางไปยัง Route/หน้าระบบตามตารางด้านล่างเพื่อทำการ Capture หน้าจอและบันทึกลงในโฟลเดอร์ "docs/images/handover/" ตามชื่อไฟล์ที่กำหนดให้ครบถ้วนตั้งแต่ Day 18 ถึง Day 37
```
...
| **Day 19** | `day19_mas_export_modal.png` | `/admin/mas` ➔ กดปุ่ม *"ส่งออก Excel"* | หน้าต่าง Modal ส่งออก Excel งบประมาณ MAS ที่มีปุ่มยืนยันการดาวน์โหลด |
...
| **Day 25** | `day25_only_me_sidebar.png` | `/procurement/requisitions` | หน้าต่างที่มีสวิตช์ฟิลเตอร์ *"Only Me"* (เฉพาะของฉัน) และแถบเมนู Sidebar ด้านข้างที่จัดหมวดหมู่ใหม่ |
...
| วันที่ | ชื่อไฟล์เป้าหมาย | URL Route / หน้าจอในระบบ | สิ่งที่ต้องแสดงในภาพหน้าจอ |
| :---: | :--- | :--- | :--- |
| **Day 27** | `day27_car_approval_workflow.png` | `/vehicle_lending/applications/<id>/detail` | หน้าจอแสดงขั้นตอนการอนุมัติคำขอใช้รถยนต์ พร้อมประวัติการลงนามของแต่ละระดับ Role |
| **Day 28** | `day28_combine_paper_batch.png` | `/vehicle_lending/combine_paper?ids=...` | หน้ารวมชุดเอกสารขอใช้รถต่อเนื่องสำหรับสั่งพิมพ์ล็อตใหญ่ (Batch Print Layout) |
| **Day 29** | `day29_printable_paper_signatures.png` | `/vehicle_lending/applications/<id>/paper` | หน้าพรีวิวเอกสารขอใช้รถสำหรับสั่งพิมพ์ พร้อมช่องลงนาม 3 ฝ่าย (ผู้ขอ, พนักงานขับรถ, ผู้อนุมัติ) |
| **Day 30** | `day30_lending_export_sign.png` | `/vehicle_lending/export_history` | รายงานประวัติการใช้รถยนต์ที่มีส่วนสำหรับลงลายมือชื่อ |
| **Day 31** | `day31_calendar_and_car_modal.png` | `/vehicle_lending/calendar` | หน้าระบบปฏิทินแสดงตารางการใช้รถ พร้อมหน้าต่าง Modal แสดงรายละเอียดคำขอ |
...
| **Day 33** | `day33_payment_number_refactor.png` | `/procurement/requisitions/details_specified` | หน้าจอแบบฟอร์มและตารางที่มีการแสดงผลฟิลด์ *"Payment Number"* (เลขที่ใบสำคัญจ่าย) |
